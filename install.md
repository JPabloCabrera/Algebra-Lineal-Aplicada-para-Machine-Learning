# machinelearninglinalg guide installation
...
activate machinelearninglinalg
```
...
To move beyond notebook prototyping, all reusable code should go into the `machinelearninglinalg/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `machinelearninglinalg` folder and use the modules inside your notebooks :
...
```python
from machinelearninglinalg.utils.paths import data_dir
data_dir()
```
